...
12. add the Healthcare Capability Deck and other approved Hire’in materials as test fixtures or seed instructions without hard-coding business text into application code;
...
# 29. Source Materials to Seed the Knowledge Base

Initial approved or review-required source candidates include:

- `Hirein_Healthcare_Staffing_Capability_Deck.pptx`
- `HireInSolns_CapablityDeck.pdf`
- `Hire-in.docx`
- `HireinAI_Business_Plan.docx`
- current company, service, delivery, compliance, and case-study content in the production system

The business plan contains internal financial assumptions and should default to `internal_only`, not general client-facing retrieval.

The capability materials contain claims that may require verification or usage restrictions, including named clients, certification/regulatory language, rapid-deployment statements, nationwide reach, and quantified experience. They must enter the claim-review workflow rather than being treated as automatically approved facts.
