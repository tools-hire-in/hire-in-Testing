...
- Complete the Proof Library extraction interview and approve at least 10 PC-## cards before production launch
...
27. Production launch is blocked until at least 10 PC-## proof cards are approved
...
Add audience-aware writing, IT and healthcare staffing expertise, commercial and government awareness, platform-native social writing, proof governance, anti-slop controls, three hook options, authored exemplars, and lightweight content-structure rotation.
...
Before production launch, complete HIREIN_PROOF_LIBRARY_EXTRACTION_INTERVIEW_v1.0.md and approve at least 10 PC-## proof cards. Do not weaken proof requirements to avoid [NEEDS_PROOF] flags.
```
...
This revision closes the final launch-readiness items:

1. Healthcare Job Marketing no longer defaults to “recent” experience.
2. Recency or minimum-duration wording is now source-controlled and optional.
3. A structured Proof Library extraction interview is added.
4. Production launch requires at least 10 approved PC-## proof cards.
5. Proof controls remain strict; missing proof is not treated as a prompt defect.
