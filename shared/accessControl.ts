...
export const ACCESS_REGISTRY: AccessRegistry = {
  ...
  "admin.applications": ["super_admin", "admin", "hr", "operations", "manager", "recruiter"],
  "admin.applications.retryCeipal": ["super_admin", "admin", "hr", "operations", "manager", "recruiter"],
  "admin.auditLogs": ["super_admin", "admin", "executive"],
  "admin.contacts": ["super_admin", "admin", "hr", "operations", "manager", "recruiter"],
  "admin.employees.dossier": ["super_admin", "admin", "hr", "operations"],
  "admin.jobs": ["super_admin", "admin", "operations", "manager", "recruiter"],
  "admin.jobs.bulkDelete": ["super_admin", "admin", "operations", "manager", "recruiter"],
  "admin.jobs.bulkUpdate": ["super_admin", "admin", "operations", "manager", "recruiter"],
  "admin.jobs.syncCeipal": ["super_admin", "admin", "operations", "manager"],
  "admin.jobs.upload": ["super_admin", "admin", "operations", "manager", "recruiter"],
  ...
  "hr.employeeDocuments.sendReminder": ["super_admin", "admin", "hr", "executive"],
  ...
  "hr.tools.offerLetters.applyToProfile": ["super_admin", "admin", "hr"],
  ...
  "salaryAdvance.create": ["super_admin", "admin", "hr", "operations", "manager", "employee", "finance", "recruiter"],
  "salaryAdvance.viewOwn": ["super_admin", "admin", "hr", "operations", "manager", "employee", "finance", "recruiter"],
  ...
  "hr.plans.goals.confirm": ["super_admin", "admin", "hr", "manager"],
  "hr.plans.goals.adjust": ["super_admin", "admin", "hr", "manager"],
  "hr.plans.goals.pendingReview": ["super_admin", "admin", "hr", "manager"],
  ...
  "travel.quotes": ["super_admin", "admin", "hr", "operations", "manager", "employee", "recruiter"],
