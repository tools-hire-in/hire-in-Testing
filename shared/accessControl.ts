...
export const ACCESS_REGISTRY: AccessRegistry = {
  ...
  "studio.view": ["super_admin", "admin", "hr", "marketing_manager", "content_manager", "content_editor", "reviewer"],
  "studio.create_article": ["super_admin", "admin", "hr", "marketing_manager", "content_manager", "content_editor"],
  "studio.edit_article": ["super_admin", "admin", "hr", "marketing_manager", "content_manager", "content_editor"],
  "studio.generate_ai_draft": ["super_admin", "admin", "marketing_manager", "content_manager", "content_editor"],
  "studio.review_article": ["super_admin", "admin", "marketing_manager", "content_manager", "reviewer"],
  "studio.cm_review": ["super_admin", "admin", "hr", "content_manager"],
  "studio.marketing_approve": ["super_admin", "admin", "hr", "marketing_manager"],
  "studio.schedule_publish": ["super_admin"],
  "studio.publish_article": ["super_admin"],
  "studio.manage_authors": ["super_admin", "admin", "hr", "marketing_manager", "content_manager"],
  "studio.manage_assets": ["super_admin", "admin", "marketing_manager", "content_manager", "content_editor"],
  "studio.view_analytics": ["super_admin", "admin", "marketing_manager", "content_manager"],
