...
export const SlideNumberContext = createContext({ slideNumber: 0, totalSlides: 11 });
    ...
    <SlideWrapper bg={NAVY} noFooter>
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "10px 36px", background: "rgba(255,255,255,0.05)", borderTop: "1px solid rgba(255,255,255,0.08)" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          <span style={{ color: "rgba(255,255,255,0.4)", fontSize: 10, fontFamily: "'Segoe UI', Arial, sans-serif" }}>hire-in.com · hello@hire-in.com</span>
...
function Slide4Services() {
  const services = [
    ...
    { icon: Code2, title: "Project-Based IT", desc: "Dedicated teams assembled for specific deliverables — from MVPs to enterprise transformation.", bullets: ["Team composition by need", "Milestone-based engagement", "Full accountability"] },
    { icon: TrendingUp, title: "RPO (Recruitment Process Outsourcing)", desc: "End-to-end outsourcing of your IT hiring pipeline — AI-assisted from intake to offer.", bullets: ["SLA-backed delivery", "Dedicated talent desk", "ATS integration"] },
  ];
  return (
    <SlideWrapper bg={LIGHT_BG}>
      <div style={{ background: NAVY, padding: "16px 36px", display: "flex", alignItems: "center", justifyContent: "space-between", flexShrink: 0 }}>
...
function Slide6KleriqAI() {
  const features = [
    { icon: FileSearch, title: "Resume Parsing & Analysis", desc: "AI scans and structures candidate resumes to extract skills, experience, and role fit in seconds." },
    { icon: Target, title: "Job Description Matching", desc: "Semantically aligns job requirements to candidate profiles — far beyond simple keyword search." },
    { icon: MessageSquare, title: "Candidate Pre-Screening", desc: "AI-driven screening conversations that qualify candidates at scale before human review." },
    { icon: Shield, title: "Bias-Free Shortlisting", desc: "Evaluates candidates purely on skills, experience, and role fit — removing demographic bias." },
    { icon: Star, title: "Fit Scoring & Ranking", desc: "Dynamic candidate ranking updated in real time as new information is captured through the pipeline." },
  ];
  return (
    <SlideWrapper bg={NAVY} noFooter>
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 20, padding: "24px 36px", position: "relative", zIndex: 1 }}>
          ...
          <div style={{ display: "flex", gap: 14, flexWrap: "wrap", justifyContent: "center" }}>
            {[
              ...
              <div key={i} style={{ background: "rgba(255,255,255,0.07)", border: "1px solid rgba(244,124,32,0.3)", borderRadius: 12, padding: "16px 24px", display: "flex", alignItems: "center", gap: 12, minWidth: 200 }}>
