...
export default function StaffingFAQ() {
  ...
  return (
    <Layout>
      <SchemaHead schema={[buildFaqSchema(allFaqs), { "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [{ "@type": "ListItem", position: 1, name: "Home", item: "https://hire-in.com/" }, { "@type": "ListItem", position: 2, name: "Staffing FAQ", item: "https://hire-in.com/staffing-faq" }] }]} />
