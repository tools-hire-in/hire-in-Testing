        ...
        <div className="relative flex items-start gap-7">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-3 flex-wrap">
              ...
              <a href="mailto:kavita@hire-in.com?subject=Starting%20My%20Staffing%20Journey"
                className="flex items-center gap-2 px-4 py-2 rounded-full text-sm font-semibold transition-all"
                style={{ background: "rgba(255,255,255,0.1)", color: "white", border: "1px solid rgba(255,255,255,0.18)", fontFamily: "'Inter',sans-serif", textDecoration: "none" }}>
                <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z" /><polyline points="22,6 12,13 2,6" /></svg>
                Email to start your staffing journey
              </a>
            </div>
          </div>
        </div>
