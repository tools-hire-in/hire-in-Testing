  ...
  return (
    <Letterhead>
      ...
      <div className="space-y-4 text-justify">
        <p>
          This is to inform that <strong>Mr. Vikram Singh</strong> (Employee ID:{' '}
        ...
        <p>
          His resignation was duly accepted, and his last working day with the organisation 
          was <strong>31/03/2026</strong>.
        </p>
        ...
        <p>
          This letter is issued at the request of the employee for record and employment purposes.
        </p>
      </div>
