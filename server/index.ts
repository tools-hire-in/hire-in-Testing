...
async function ensureHealthcarePlansTables() {
  ...
  try {
    ...
    const templates: {
      ...
      { plan_type: "growth", role_slug: "foundation_to_senior", goal_category: "production", goal_title: "D1-30: Clean POs or starts", goal_description: "Close at least 1–2 clean POs or confirmed starts from the live pipeline in the first 30 days, assuming client demand remains active. A PO only counts when the candidate starts, stays, and bills consistently.", target_metric: "Minimum 1–2 clean POs or starts with PO confirmation and candidate acceptance documented", sort_order: 4 },
      ...
      { plan_type: "growth", role_slug: "foundation_to_senior", goal_category: "production", goal_title: "D31-60: Clean POs or starts", goal_description: "Close 1–2 additional clean POs or confirmed starts. Focus on retained placements where the candidate starts, stays, and bills consistently — not just initial PO receipt.", target_metric: "1–2 additional clean POs or starts with PO confirmation and retained candidate status documented", sort_order: 9 },
      ...
      { plan_type: "growth", role_slug: "foundation_to_senior", goal_category: "production", goal_title: "D61-90: Total clean POs or starts — 90-day target", goal_description: "Reach the 90-day placement target with clean, retained starts. Strong performance is 4+ clean POs/starts. Each placement is assessed on whether the candidate started, stayed, billed, and the client relationship remained stable.", target_metric: "Minimum 3 clean POs/starts across 90 days; strong performance = 4+; PO/start and retained billing status documented", sort_order: 15 },
