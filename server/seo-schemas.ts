...
const WHYHIREIN_FAQ_SCHEMA = {
  ...
  mainEntity: [
    ...
    { "@type": "Question", name: "What makes Hire'in Solutions different from other staffing agencies?", acceptedAnswer: { "@type": "Answer", text: "Hire'in Solutions uses proprietary AI tools including kleriq.AI for IT talent matching and CredentialRx.ai for healthcare credential verification. This enables 24-hour first candidate submissions, 92% AI match accuracy, and 95% client retention — faster and more accurate than traditional staffing methods." } },
...
const STAFFINGFAQ_FAQ_SCHEMA = {
  ...
  mainEntity: [
    ...
    { "@type": "Question", name: "How does Hire'in Solutions verify healthcare credentials?", acceptedAnswer: { "@type": "Answer", text: "Using CredentialRx.ai (proKred.com): state nursing board license checks, DEA number validation for prescribers, BLS/ACLS/PALS/NRP certification verification, background checks, OIG/SAM exclusion screening, and reference checks — compiled into a compliant submission package before any candidate is presented." } },
