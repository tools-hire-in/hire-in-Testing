...
- **New Hire Section** (`/admin/new-hire`): Dedicated page for the pre-employment pipeline accessible to all roles except employee (super_admin, admin, hr, operations, manager). Two tabs: **Offer Letters** (OfferLetterGenerator + OfferLettersDashboard; managers can generate/track, HR/admin can approve/countersign) and **Onboarding** (status table of employees joined within last 90 days showing training %, documents uploaded, bank details, night-shift consent).
